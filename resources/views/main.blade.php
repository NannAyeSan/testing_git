...
<!-- Sub Nav (WEB) -->
	...
	<div class="container mt-5 px-5">
	    ...
	    <section class="customer-logos slider mt-5">
	      	<div class="slide">
	      		<a href="">
		      		<img src="{{asset('front/image/brand/loacker_logo.jpg')}}" class="img-fluid">
		      	</a>
	      	</div>
	      	
	      	<div class="slide">
	      		<a href="">
	      			<img src="{{asset('front/image/brand/lockandlock_logo.png')}}" class="img-fluid">
	      		</a>
	      	</div>
	      	
	      	<div class="slide">
	      		<a href="">
	      			<img src="{{asset('front/image/brand/apple_logo.png')}}" class="img-fluid">
	      		</a>
	      	</div>
	      	...
	      	<div class="slide">
	      		<a href="">
	      			<img src="{{asset('front/image/brand/saisai_logo.png')}}" class="img-fluid">
	      		</a>
	      	</div>
